...
export interface BolsaDeTrabajoParseResult {
  ...
  metadata: Pick<
    ...
    "zona" | "categoria" | "totalRegistros" | "extraidoCon"
  >;
  errores: string[];
}
...
export function detectarTipoDocumentoPorNombre(
  ...
  if (
    nombreNormalizado.includes("NUEVO") &&
    nombreNormalizado.includes("INGRESO")
  ) {
